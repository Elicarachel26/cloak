                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                placeholder="Reward Name" value="{{ old('name') }}" required>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" name="type" required>
                                ...
                                <option value="free-shipping" {{ old('type')=='free-shipping' ? 'selected' : '' }}>Free
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="number" class="form-control @error('point') is-invalid @enderror" name="point"
                                placeholder="Point" value="{{ old('point') }}" required>
